    ...
    <section class="formboxcontainer">
      ...
      <div class="formsection">
        ...
        <form
          ...
          action="${pageContext.request.contextPath}/UserEdit" method="post" enctype="multipart/form-data">
           <% 
	...
	<% if (registerMessage != null) { %>
		...
		<% } %>
          ...
          <input type="hidden" name="userId" value="<%=userId%>"/>
			...
			<div class="userType"style="width: 100%">
        ...
        <br>
        <br>
         <form method="post" action = "${pageContext.request.contextPath}/View/Pages/EditUserWithPicture.jsp">
         				<input type="hidden" name="userId" value="<%=userId%>"/>

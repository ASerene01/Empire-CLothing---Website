...
<!--start of navigation from where all the main pages can be accessed-->
    ...
    <section class="formboxcontainer">
      ...
      <div class="formsection">
        ...
        <form
          ...
          action="${pageContext.request.contextPath}/ProfileUpdateCustomer" method="post" enctype="multipart/form-data">
           <% 
	...
	<% if (registerMessage != null) { %>
        ...
        <br>
        <br>
         <form method="post" action = "${pageContext.request.contextPath}/View/Pages/ProfileUpdateCustomerPicture.jsp">
         				<input type="hidden" name="userId" value="<%=userId%>"/>

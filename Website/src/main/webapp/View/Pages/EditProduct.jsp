      ...
      <div class="formsection">
        ...
        <!--start of the form -->
         <form
          ...
          action="${pageContext.request.contextPath}/ProductUpdate" method="post" enctype="multipart/form-data">
        ...
        <br>
         ...
         <form method="post" action = "${pageContext.request.contextPath}/View/Pages/EditProductWithPicture.jsp">
                          <input type="hidden" name="productId" value="<%=productId%>"/>
                        ...
                        <input type="hidden" name="productSearchTag" value="<%=productSearchTag%>}" />

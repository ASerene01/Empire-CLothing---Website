...
<!--start of middle section where the main purpose of page is shown-->
  ...
  <ul class="sidenav-list">
    ...
    <li><a href="${pageContext.request.contextPath}/View/Pages/homeGroupByCategory.jsp" class="productlinkcolor">Sort By Category</a></li>
 	    ...
 	    <c:forEach var="product" items="${allProducts.rows}">
            <div class="products">
            	<div class="imagecartcontainer">
                	...
                	<form method="post" class= "cartForm" action = "<%if(!mySession.checkUser(user)){
		    					out.print(mainPath);%>/View/Pages/Login.jsp<%
		   					} 
		    				else {
		    					out.print(mainPath);%>/AddToCart<%
		   					}%>">

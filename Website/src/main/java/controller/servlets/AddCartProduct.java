...
/**
 * Servlet implementation class AddCartProduct
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/AddCartProduct" })
...
public class AddCartProduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result == 1) {
			...
			request.getRequestDispatcher(request.getContextPath()+"/View/Pages/Cart.jsp").forward(request, response);
		}

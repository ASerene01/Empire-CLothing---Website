...
public class ProductsUpdateWithPicture {
	String productId, productName, productCategory, productBrand, productPrice, productStock, productSearchTag, profilePicture, productRating;
	public ProductsUpdateWithPicture() {}
	
	public ProductsUpdateWithPicture(String productId, String productName, String productCategory, String productBrand, 
